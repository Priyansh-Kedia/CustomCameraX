...
import com.kedia.customcameraxmultiple.utils.makeGone
import com.kedia.customcameraxmultiple.utils.makeVisible
...
class CustomCameraX: FrameLayout, CustomImageAdapter.CustomAdapterClick, LifecycleOwner {
    ...
    private lateinit var listener: CustomCameraX
    ...
    fun setListener(listener: CustomCameraX) {
